...
/*******************************************************************************
 **
 ** Function         hid_host_menu_display
 **
...
{
    printf("Bluetooth Application HID Host menu:\n");
...
int hid_host_menu_handle(void)
{
    ...
    app_mgt_custom_cback_update(app_hh_mgt_callback);
    /* Init XML state machine */
    app_xml_init();

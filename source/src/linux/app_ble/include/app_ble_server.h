...
/*******************************************************************************
 **
 ** Function        int app_ble_server_start_battery_service(void)
 **
 ** Description     Send indication to client
 **
 ** Parameters      None
...
/*******************************************************************************
 **
 ** Function        int app_ble_server_start_device_info_service(void)
 **
 ** Description     Send indication to client
 **
 ** Parameters      None
...
/*******************************************************************************
 **
 ** Function        int app_ble_server_start_hogp_device_service(void)
 **
 ** Description     Send indication to client
 **
 ** Parameters      None
...
/*******************************************************************************
 **
 ** Function        int app_ble_server_send_key_by_hogp(void)
 **
 ** Description     Send indication to client
 **
 ** Parameters      None
...
/*******************************************************************************
 **
 ** Function        void app_ble_server_chars_handle_profile_cback
 ** Description     Send indication to client
 **
 ** Parameters      None
 **
 ...
 **
 *******************************************************************************/
void app_ble_server_chars_handle_profile_cback(tBSA_BLE_EVT event,  tBSA_BLE_MSG *p_data);

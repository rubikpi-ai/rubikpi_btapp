...
#ifndef DEMO_MODE
    APP_AV_MENU_SP_ACCEPT,
    APP_AV_MENU_SP_REFUSE,
#endif
    APP_AV_MENU_STOP,
    APP_AV_MENU_PAUSE,
    APP_AV_MENU_RESUME,
...
{
    printf("Bluetooth Application AV menu\n");
...
int av_menu_handle(void)
{
    ...
    app_mgt_custom_cback_update(app_av_mgt_callback);
    /* Init XML state machine */
    app_xml_init();

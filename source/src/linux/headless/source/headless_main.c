...
/*******************************************************************************
 **
 ** Function         headless_menu_display
 **
...
{
    APP_INFO0("Bluetooth Application Headless menu:");
...
int headless_menu_handle(void)
{
    ...
    app_mgt_custom_cback_update(app_headless_mgt_callback);

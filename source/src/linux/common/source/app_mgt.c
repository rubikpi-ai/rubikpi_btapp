...
/*******************************************************************************
 **
 ** Function        app_mgt_custom_cback_update
 **
 ** Description    Different submenus may use different custom callbacks. 
 ** This function is used to replace custom callbacks when making menu switches.
 **
 ** Parameters      
 **                 
 **
 ...
 **
 *******************************************************************************/
void app_mgt_custom_cback_update(tAPP_MGT_CUSTOM_CBACK *p_mgt_callback)
{

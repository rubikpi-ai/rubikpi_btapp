...
typedef enum
{
    ...
    BSA_SEC_TX_POWER_EVT,       /* TX Power report received */
...
#define BSA_SEC_SIG_STRENGTH_TX_POWER       BTA_SIG_STRENGTH_TX_POWER_MASK
...
typedef INT8 tBSA_SEC_TX_POWER_VALUE;
...
typedef struct
{
    ...
    tBSA_SEC_TX_POWER_VALUE tx_power_value;

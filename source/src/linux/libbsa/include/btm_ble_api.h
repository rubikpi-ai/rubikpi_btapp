...
#define BTM_BLE_AD_BIT_MESH_BEACON      (0x00000001 << 18)      /*Mesh Beacon*/
#define BTM_BLE_AD_BIT_MESH_MESSAGE     (0x00000001 << 19)      /*Mesh Message*/
#define BTM_BLE_AD_BIT_MESH_PBADV       (0x00000001 << 20)      /*Mesh Pbadv*/
...
#define BTM_BLE_AD_TYPE_32SOL_SRV_UUID  0x1F  /* TBD */
#define BTM_BLE_AD_TYPE_32SERVICE_DATA  0x20  /* TBD */
#define BTM_BLE_AD_TYPE_128SERVICE_DATA 0x21 /* TBD */
#define BTM_BLE_AD_TYPE_TDS             0x26
#define BTM_BLE_AD_TYPE_MESH_PBADV      0x29     /*Mesh Beacon*/
#define BTM_BLE_AD_TYPE_MESH_MESSAGE    0x2a     /*Mesh Message*/
#define BTM_BLE_AD_TYPE_MESH_BEACON     0x2b     /*Mesh Pbadv*/

/* ++Mesh definition ++*/
#define ADV_AD_DATA_LEN     31

#define BTM_MESH_TRANSACTION_START       0
#define BTM_MESH_TRANSACTION_ACK         1
#define BTM_MESH_TRANSACTION_CONTINUE    2
#define BTM_MESH_CONTROL                 3

#define BTM_MESH_LINK_OPEN      0x00
#define BTM_MESH_LINK_ACK       0x01
#define BTM_MESH_LINK_CLOSE     0x02

#define DEVICE_UUID_LEN     16
#define PBADV_LINK_ID_LEN   4

#define BTM_PBADV_PACKET_OVERHEAD               (4 /* Link ID */ + 1 /* Transaction number */)
#define BTM_TRANSACTION_START_OVERHEAD          (1 /* SegN+GPCF */ + 2 /* Total len */ + 1 /* FCS */)
#define BTM_TRANSACTION_ACK_LEN                 (1 /* SegN+GPCF */)
#define BTM_TRANSACTION_CONTINUATION_OVERHEAD   (1 /* SegN+GPCF */)
#define BTM_LINK_OPEN_LEN                       (1 /* Control ID+GPCF */ + 16)//NRF_MESH_UUID_SIZE)
#define BTM_LINK_ACK_LEN                        (1 /* Control ID+GPCF */)
#define BTM_LINK_CLOSE_LEN                      (1 /* Control ID+GPCF */ + 1 /* Reason */)

/* Max length of TRANSACTION_START*/
#define BTM_TRANSACTION_START_MAXLEN  (ADV_AD_DATA_LEN - (BTM_PBADV_PACKET_OVERHEAD + BTM_TRANSACTION_START_OVERHEAD))

/* Max length of TRANSACTION_CONTINUATION*/
#define BTM_TRANSACTION_CONTINUATION_MAXLEN (ADV_AD_DATA_LEN -(BTM_PBADV_PACKET_OVERHEAD + BTM_TRANSACTION_CONTINUATION_OVERHEAD))
/* --Mesh definition --*/
...
typedef struct
{
    UINT8       len;
    UINT8      *p_val;
}tBTM_BLE_MESH_BEACON;

/* TBD- Mesh Message*/

typedef struct {
	int				dataLen;
	unsigned char   net_data[32];
}tBTM_BLE_MESH_NET;
...
typedef union
{
    struct
    {
        ...
        UINT8   payload[BTM_TRANSACTION_START_MAXLEN];  /* Packet payload */
    } tran_start;

    struct
    {
        UINT8  payload[BTM_TRANSACTION_CONTINUATION_MAXLEN];  /* Packet payload */
    } tran_cont;
} tBTM_GENERIC_TRANSACTION;
...
typedef struct
{
    ...
    union
    {
        tBTM_GENERIC_PROC_CONTROL  control;     /* Control PDU. */
        tBTM_GENERIC_TRANSACTION   transaction; /* Transaction PDU. */
    } payload;
} tBTM_GENERIC_PROV_PDU;
...
typedef struct
{
    ...
    UINT32                  linkID;
    UINT8                   trans_num;
    tBTM_GENERIC_PROV_PDU   generic_prov_pdu;
}tBTM_BLE_MESH_PBADV;
...
typedef struct
{
    ...
    /* TBD- Mesh Message*/
    tBTM_BLE_MESH_BEACON    *p_mesh_beacon;     /* mesh beacon */
    tBTM_BLE_MESH_NET		*p_mesh_netdata;	/* mesh network data */
    tBTM_BLE_MESH_PBADV     *p_mesh_pbadv;      /* mesh PB-ADV */
#endif
    UINT16                  appearance;
    UINT8                   flag;
    UINT8                   tx_power;

...
#define BTA_PBS_FILTER_USED                  (0xffffffff) /* Mask for bits used */

typedef UINT64 tBTA_PBS_SELECTOR_MASK;

/* Selector Operation */
enum
{
    BTA_PBS_SELECTOR_OPERATION_OR = 0x00,  /* Vcard 'or' selector operation */
    BTA_PBS_SELECTOR_OPERATION_AND         /* Vcard 'and' selector operation */
};
typedef UINT8 tBTA_PBS_SELECTOR_OPERATION;

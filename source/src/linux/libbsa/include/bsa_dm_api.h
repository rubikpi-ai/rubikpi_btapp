...
#define BSA_DM_CONFIG_MONITOR_TXPOWER_MASK      0x200000
...
#define BSA_DM_BLE_AD_BIT_MESH_BEACON     BTM_BLE_AD_BIT_MESH_BEACON         /*Mesh Beacon*/
#define BSA_DM_BLE_AD_BIT_MESH_MESSAGE    BTM_BLE_AD_BIT_MESH_MESSAGE       /*Mesh Message*/
#define BSA_DM_BLE_AD_BIT_MESH_PBADV      BTM_BLE_AD_BIT_MESH_PBADV           /*Mesh Pbadv*/
...
typedef struct
{
    ...
    union
    {
        tGENERIC_PROC_CONTROL  control;     /* Control PDU. */
        tGENERIC_TRANSACTION   transaction; /* Transaction PDU. */
    } payload;
} tGENERIC_PROV_PDU;
...
typedef struct
{
    ...
    UINT32              linkID;
    UINT8               trans_num;
    tGENERIC_PROV_PDU   generic_prov_pdu;
}tBSA_DM_MESH_PBADV;
...
typedef struct
{
    ...
    UINT8                     service_data_len[BSA_DM_BLE_AD_UUID_MAX]; /* length = AD type + service data uuid + data) */
    tBT_UUID                  service_data_uuid[BSA_DM_BLE_AD_UUID_MAX]; /* service data uuid */
    UINT8                     service_data_val[BSA_DM_BLE_AD_UUID_MAX][BSA_DM_BLE_AD_DATA_LEN];
    ...
    tBSA_DM_MESH_BEACON       mesh_beacon;     /* mesh beacon */
    tBSA_DM_MESH_NET          mesh_net;     /* mesh net message */
    tBSA_DM_MESH_PBADV        mesh_pbadv;      /* mesh pbadv */
#endif
...
/* enable tx power monitoring */
typedef struct
{
    BOOLEAN enable; /* Monitor Tx Power enable */
    UINT16  period; /* Period in seconds */

}tBSA_DM_MONITOR_TXPOWER_PARAM;
...
typedef struct
{
    ...
    tBSA_DM_MONITOR_TXPOWER_PARAM monitor_txpower_param; /* Monitor TX Power */
} tBSA_DM_GET_CONFIG;

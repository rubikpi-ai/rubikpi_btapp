...
#define BSA_TM_BSA_SERVER_VERSION_LEN 80  /* Length of BSA_SERVER_VERSION */
#define BSA_TM_BSA_SERVER_VERSION_INFO_LEN 128  /* Length of BSA_SERVER_VERSION */
#define BSA_TM_CHANNEL_MAP_LEN  10  /* Length of Channel Map */
#define BSA_TM_MIN_ANT_PAT_LEN  0x02  /* Min Length of Antenna Switch Pattern */
#define BSA_TM_MAX_ANT_PAT_LEN  0x4B  /* Max Length of Antenna Switch Pattern */
...
#define BSA_TM_TRACE_LEVEL_CUSTOM   BT_TRACE_LEVEL_CUSTOM   /* Customer specific trace messages     */
...
#define BSA_TM_TRACE_LEN_MAX        256
...
typedef struct
{
    ...
    UINT8 trace_text[BSA_TM_TRACE_LEN_MAX];
...
typedef struct
{
    ...
    UINT8 bsa_server_version_info[BSA_TM_BSA_SERVER_VERSION_INFO_LEN];
...
#define BSA_LE_TX_V3_TEST_CMD  3
#define BSA_LE_TX_V4_TEST_CMD  4
...
typedef struct
{
    ...
    UINT8 cte_len;
    UINT8 cte_type;
    UINT8 switch_pattern_len;
    UINT8 antenna_id[BSA_TM_MAX_ANT_PAT_LEN];
    BOOLEAN sup_tx_pwr_lvl;
    UINT8 tx_pwr_lvl;
    UINT16 retcount;
} tBSA_TM_LE_CMD;
...
typedef struct
{
    ...
    UINT8 hopping_mode;
    UINT8 frequency;
    UINT8 chan_map[BSA_TM_CHANNEL_MAP_LEN];
    UINT8 conn_interval;
    UINT8 num_of_packets;
    UINT8 modulation_type;
    UINT8 logical_channel;
    UINT8 bb_packet_type;
    UINT16 bb_packet_length;
...
/*******************************************************************************
 **
 ** Function         BSA_TmSetTraceTextInit
 **
 ** Description      Initialize the tBSA_TM_SET_TRACE_LEVEL structure to default values.
 **
 ** Parameters       Pointer on structure containing API parameters
 ...
 **
 *******************************************************************************/
extern tBSA_STATUS BSA_TmSetTraceTextInit(tBSA_TM_SET_TRACE_LEVEL *p_req);

/*******************************************************************************
 **
 ** Function         BSA_TmSetTraceText
 **
 ** Description      Function to add trace to BSA server
 **
 ** Parameters       Pointer on structure containing API parameters
 **
 ** Returns          Status
 **
 *******************************************************************************/
extern tBSA_STATUS BSA_TmSetTraceText(tBSA_TM_SET_TRACE_LEVEL *p_req);

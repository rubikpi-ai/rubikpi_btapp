...
int app_ble_eddystone_start_eddystone_uid_adv(UINT8 index)
{
    ...
    adv_conf.service_data_len[0] = APP_BLE_EDDYSTONE_SERVICE_DAT_LEN;
    memcpy(&adv_conf.service_data_val, &service_data, APP_BLE_EDDYSTONE_SERVICE_DAT_LEN);
    adv_conf.service_data_uuid[0].len = 2;
    adv_conf.service_data_uuid[0].uu.uuid16 = APP_BLE_EDDYSTONE_UUID16;

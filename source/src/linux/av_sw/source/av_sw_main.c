...
{
    APP_INFO0("\nBluetooth Application AV & AG TO AVK & HF Switch menu");
...
int av_sw_menu_handle(void)
{
    ...
    app_mgt_custom_cback_update(app_switch_mgt_callback);
    /* Init XML state machine */
    app_xml_init();

...
int app_ble_tvselect_server_start(void)
{
    ...
    adv_conf.service_data_len[0] = BSA_DM_BLE_AD_SERVICE_DATA_LEN-1; /*1 = length*/
    adv_conf.service_data_uuid[0].len = sizeof(adv_meta_data.service_uuid);
    adv_conf.service_data_uuid[0].uu.uuid16 = adv_meta_data.service_uuid;
...
void app_ble_tvselect_server_update_advertise_packet(UINT16 metatype, UINT8* metadata, UINT16 len)
{
    ...
    adv_conf.service_data_len[0] = BSA_DM_BLE_AD_SERVICE_DATA_LEN-1;
